        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden border-2 border-blue-600">
            ...
            <div className="p-8 space-y-6">
              ...
              {/* Event Details Grid */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-y py-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3">
                  <AddressIcon className="w-5 h-5 text-slate-400 mt-1 flex-shrink-0" />
                  <div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                <p className="text-sm text-slate-700 line-clamp-3">{registration.event.description}</p>
              </div>
